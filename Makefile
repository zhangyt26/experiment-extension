...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="time_travel" -DDUCKDB_OOT_EXTENSION_TIME_TRAVEL_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_TIME_TRAVEL_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_TIME_TRAVEL_INCLUDE_PATH="$(PROJ_DIR)src/include"
